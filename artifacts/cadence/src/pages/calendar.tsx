  ...
  return (
    <div className="mx-auto max-w-[1320px]">
      <section className="mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
        ...
        <Link href="/dashboard" className="inline-flex w-fit items-center gap-2 rounded-[10px] bg-[#C2410C] px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-[#9a340a]" data-testid="button-calendar-schedule">
